...
class ACPSession:
    ...
    def _start_stderr_drain(self, process: asyncio.subprocess.Process) -> None:
        """Start the stderr reader before handshake so initialize failures are observed.
    ...
    async def _open_body(self) -> None:  # noqa: PLR0915 - spawn, handshake, session, model/effort, and pre-prompt budget
        ...
        try:
            try:
                ...
                await self.close()
                handshake_error = self._handshake_failure(
